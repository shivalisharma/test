...
<html>
 <head>
  ...
  <script>
	 ...
	 var columns = new Array("name","email","designation");
	 var placeholder = new Array("Enter First Name","Enter Email","Enter Designation");
 ...
 <body>
	<table border="0" class="tableDemo bordered">
		...
		<tr id="<?php echo$eachRecord['id']; ?>">
			...
			<td class="designation"><?php echo $eachRecord['designation'];?></td>
			<td>
